...
@endsection
@section('akun')
<a class="nav-link" href="/Mahasiswa/Home/ListMahasiswa"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
